<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="xytable.aspx.cs" Inherits="EmptyProjectNet40_FineUI.统计.xytable" %>
            ...
            <Items>
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center"
                    ...
                    <Items>
                        ...
                        AllowSorting="true" SortField="XY" SortDirection="ASC"
                        OnSort="Grid1_Sort"  >
                         <Columns>
                         
                         <f:GroupField EnableLock="true" HeaderText="2018年第1学期第1周多媒体教室异常数据统计表" TextAlign="Center">
                          <Columns>
                          <f:BoundField width="100px" DataField="XY" SortField="XY" HeaderText="学院" />
