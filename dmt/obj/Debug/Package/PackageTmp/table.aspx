<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="True" CodeBehind="table.aspx.cs" Inherits="EmptyProjectNet20.table" %>
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                ...
                <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="true" EnableCollapse="true"
                    ...
                    <Items>
                    <f:Image ID="imgPhoto" CssClass="photo" ImageUrl="~/res/images/blank.png"  runat="server">
                </f:Image>
                ...
                <f:Panel runat="server" ID="panelCenterRegion" RegionPosition="Center"
                    ...
                    <Items>
                        <f:Grid ID="Grid1" Title="表格"  EnableCollapse="true" Width="800px" PageSize="14" ShowBorder="true" ShowHeader="false"
                        AllowPaging="true" runat="server" EnableCheckBoxSelect="True"
                        DataKeyNames="RoomID,SKRQ,JC,RKJSGH,BZ" IsDatabasePaging="true" OnPageIndexChange="Grid1_PageIndexChange"
                        AllowSorting="true" SortField="XM" SortDirection="ASC"
                        OnSort="Grid1_Sort" EnableRowSelectEvent="true" OnRowSelect="Grid1_RowSelect">
                         <Columns>
                         <f:GroupField EnableLock="true" HeaderText="2018年第1学期第1周多媒体教室异常数据统计表" TextAlign="Center">
                          <Columns>
                         
                                   
                                    <f:BoundField Width="80px" SortField="id" DataField="id" HeaderText="id"  />
                                    <f:BoundField Width="100px" DataField="SKRQ" SortField="SKRQ" DataFormatString="{0}"
                                        HeaderText="日期" />
                                    <f:BoundField Width="120px" SortField="XM" DataField="XM" HeaderText="姓名" />
                                    <f:BoundField Width="80px" SortField="RKJSGH" DataField="RKJSGH" HeaderText="职工号" />
                                    <f:BoundField Width="180px" SortField="MC" DataField="MC" HeaderText="学院/单位" />
                                    <f:BoundField Width="80px" SortField="RoomName" DataField="RoomName" HeaderText="上课教室" />
                                     <f:BoundField Width="120px" SortField="BuildingName" DataField="BuildingName" HeaderText="上课教学楼" />
                                    <f:BoundField Width="80px" SortField="JC" DataField="JC" HeaderText="节次" />
                                    <f:BoundField Width="80px" SortField="BZ" DataField="BZ" HeaderText="备注" />
