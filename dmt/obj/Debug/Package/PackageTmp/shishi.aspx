<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="shishi.aspx.cs" Inherits="EmptyProjectNet20.shishi" %>
                    ...
                    <Items>
                        ...
                        OnSort="Grid1_Sort" EnableRowSelectEvent="true" OnRowSelect="Grid1_RowSelect">
                         <Columns>
                                    ...
                                    <f:BoundField Width="260px" SortField="MC" DataField="MC" HeaderText="学院/单位" />
                                    <f:BoundField Width="180px" SortField="RoomName" DataField="RoomName" HeaderText="上课教室" />
                            ...
                            <Toolbars>
                                <f:Toolbar ID="Toolbar2" runat="server" Position="Bottom">
                                   ...
                                   <%-- <f:DropDownList runat="server" ID="DropDownList1" Width="130"  LabelWidth="40px"  AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Label="学年" >
                                    ...
                                    <f:DropDownList runat="server" ID="DropDownList4" Width="250"  LabelWidth="40px" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Label="学院" AutoSelectFirstItem="False">
