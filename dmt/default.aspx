                        ...
                        <div id="header">
                            <table>
                                <tr>
                                    <td>
                                        <div class="title">
                                            <a href="./default.aspx">多媒体教学监督系统</a>
                                        </div>
                                    </td>
                ...
                <f:Region ID="Region2" Split="true" Width="200px" ShowHeader="true" Title="菜单"
                    ...
                    <Items>
                        <f:Tree runat="server" ShowBorder="false" ShowHeader="false" EnableArrows="true" EnableLines="true" ID="leftMenuTree">
                            <Nodes>
                                <f:TreeNode Text="多媒体数据查询" Expanded="true">
                                    <f:TreeNode Text="实时查询" NavigateUrl="~/多媒体异常数据/YC_Now.aspx"></f:TreeNode>
                                    <f:TreeNode Text="历史数据" NavigateUrl="~/多媒体异常数据/YC_Histroy.aspx"></f:TreeNode>
                                    <f:TreeNode Text="统计信息" NavigateUrl="~/多媒体异常数据/YC_Histroy_Count.aspx"></f:TreeNode>
                                    
                                </f:TreeNode>
                                <f:TreeNode Text="多媒体教学数据查询" Expanded="true">
                                    <f:TreeNode Text="课表数据查询" NavigateUrl="~/多媒体教学数据/Class.aspx"></f:TreeNode>
                                    <f:TreeNode Text="插卡使用数据" NavigateUrl="~/多媒体教学数据/ClassRoom.aspx"></f:TreeNode>
                                    <f:TreeNode Text="远程开启数据" NavigateUrl="~/多媒体教学数据/ClassRoomNoCard.aspx"></f:TreeNode>
                                    <f:TreeNode Text="监控截图数据" NavigateUrl="~/多媒体教学数据/PicLIST.aspx"></f:TreeNode>
                                    
                                </f:TreeNode>
                                <f:TreeNode Text="判定依据" Expanded="true" NavigateUrl="~/admin/admin.aspx">
                                    
                                    <f:TreeNode Text="判定规则" NavigateUrl="~/异常数据判定依据/Rule.aspx"></f:TreeNode>
                    ...
                    <Items>
                        <f:ContentPanel ID="ContentPanel3" runat="server" ShowBorder="false" ShowHeader="false">
                            <table class="bottomtable">
                                <tr>
                                    <td style="width: 300px;">&nbsp;版本：<a target="_blank" href="~/admin/admin.aspx">2.0</a>
                                        &nbsp;&nbsp; </td>
