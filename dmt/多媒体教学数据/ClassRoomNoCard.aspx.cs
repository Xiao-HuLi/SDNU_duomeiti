...
{
    public partial class ClassRoomNoCard : System.Web.UI.Page
    {
        ...
        private string backsql()
        {
            ...
            if (XN == "2018") { XN = "'2018-08-25 00:00:00.000' and [BeginTime]< '2019-01-13 00:00:00.000'"; } else { XN = "'2019-01-13 00:00:00.000'"; }
            string sql = @"SELECT  [duomeiti].[dbo].[DMT_YKT].RYBH,a.*,[duomeiti].[dbo].[DMT_YKT].XM,[duomeiti].[dbo].[DMT_YKT].MC,[duomeiti].[dbo].[RoomInfo].[RoomName],[BuildingName] 
 FROM [duomeiti].[dbo].[YC] as a,[duomeiti].[dbo].[DMT_YKT],[duomeiti].[dbo].[RoomInfo],[duomeiti].[dbo].[buildinginfo] where 
 [duomeiti].[dbo].[RoomInfo].[RoomID]=a.[RoomID] and a.RKJSGH=[duomeiti].[dbo].[DMT_YKT].RYBH and bz='远程开启' AND [duomeiti].[dbo].[buildinginfo].[BuildingID]=[duomeiti].[dbo].[RoomInfo].[BuildingID]  and XN='" + DropDownList1.SelectedItem.Text + "'"; ;
            ...
            if (TextBox2.Text != "")
            {
                sql = sql + "and [RYBH]='" + TextBox2.Text + "' ";
            }
            if (TextBox3.Text != "")
            {
                sql = sql + "and [RoomName] like '%" + TextBox3.Text + "%' ";
            }
        ...
        private void CheckSelection()
        {
            ...
            {
                tabletitle.HeaderText = xn + "学年第" + DropDownList2.SelectedItem.Text + "学期第" + DropDownList3.SelectedItem.Text + "周" + xy + "<br>多媒体教室远程协助开启教室数据汇总表";
            }
            else
            {
                tabletitle.HeaderText = xn + "学年第" + DropDownList2.SelectedItem.Text + "学期" + xy + "<br>多媒体教室远程协助开启教室数据汇总表";
            }
