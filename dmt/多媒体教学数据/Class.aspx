<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Class.aspx.cs" Inherits="EmptyProjectNet40_FineUI.多媒体教学数据.Class" %>
...
<body>
    ...
    <f:PageManager ID="PageManager1" AutoSizePanelID="Grid1" runat="server" />
      ...
      <f:Grid ID="Grid1" Title="表格"  EnableCollapse="true"  PageSize="10" ShowBorder="true" ShowHeader="false"
                        ...
                        DataKeyNames="XM,MC" IsDatabasePaging="TRUE" OnPageIndexChange="Grid1_PageIndexChange"
                        AllowSorting="true" SortField="RKJSGH" SortDirection="ASC"
                        OnSort="Grid1_Sort" ForceFit="true" >
                         <Columns>
                         
                         <f:GroupField  HeaderText="2018-2019年第2学期第1周<br>多媒体教室异常数据统计表" TextAlign="Center" ID="tabletitle" MinWidth="1000px" BoxFlex="1">
                          <Columns>
                           <f:BoundField width="80px" DataField="RKJSGH" SortField="RKJSGH" HeaderText="工号" />
                           ...
                           <f:BoundField width="80px" DataField="XQJ" SortField="XQJ" HeaderText="星期几" />
                           <f:BoundField width="80px" DataField="JC" SortField="JC" HeaderText="第几节" /> 
                           <f:BoundField width="80px" DataField="RoomName" SortField="RoomName" HeaderText="教室" /> 
                           <f:BoundField Minwidth="180px" BoxFlex="2" DataToolTipField="BuildingName" HtmlEncode="false" DataField="BuildingName" SortField="BuildingName" HeaderText="教学楼" /> 
                           <f:BoundField width="80px" DataField="ZC" SortField="ZC" HeaderText="第几周" />
                           <f:BoundField width="80px" DataField="DSZ" SortField="DSZ" HeaderText="单双周" />
