...
namespace EmptyProjectNet40_FineUI.多媒体教学数据
{
    public partial class ClassRoom : System.Web.UI.Page
    {
        ...
        private string backsql()
        {
            ...
            string sql = @"SELECT [duomeiti].[dbo].[DMT_YKT].RYBH,a.[RoomID],[BeginTime],[EndTime],a.[CardNo],a.[SquareName],a.[BuildingName],a.[RoomName],a.[BuildingID],[duomeiti].[dbo].[DMT_YKT].XM,[duomeiti].[dbo].[DMT_YKT].MC,[duomeiti].[dbo].[RoomInfo].[RoomName] 
 FROM [172.27.16.250].[dscontrol].[dbo].[v_RoomUseDetail] as a,[duomeiti].[dbo].[DMT_YKT],[duomeiti].[dbo].[RoomInfo],[duomeiti].[dbo].[cardinfo] where 
 [duomeiti].[dbo].[RoomInfo].[RoomID]=a.[RoomID]  and [duomeiti].[dbo].[cardinfo].[CardNo] = a.[CardNo] 
 and [duomeiti].[dbo].[cardinfo].[EmployeeID]=[duomeiti].[dbo].[DMT_YKT].RYBH  and [BeginTime]>" + XN;
        ...
        private void CheckSelection()
        {
            ...
            {
                tabletitle.HeaderText = xn + "学年第" + DropDownList2.SelectedItem.Text + "学期第" + DropDownList3.SelectedItem.Text + "周" + xy + "<br>多媒体教室使用数据汇总表";
            }
            else
            {
                tabletitle.HeaderText = xn + "学年第" + DropDownList2.SelectedItem.Text + "学期" + xy + "<br>多媒体教室使用数据汇总表";
            }
